...
export const DEFAULT_BADGES: Badge[] = [
  ...
  { id: 'world_2_unlock',   name: 'Istraživač',        description: 'Otključao/la Svet slova',          emoji: '🗺️', unlockedAt: null },
  { id: 'world_3_unlock',   name: 'Hodač senki',       description: 'Otključao/la Svet senki',          emoji: '🌘', unlockedAt: null },
];
